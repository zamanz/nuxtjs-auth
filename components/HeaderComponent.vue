                ...
                <div class="col-md-4">
                    <nav class="navbar navbar-expand py-0 d-flex justify-content-end">
                        <div id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                <li class="nav-item nav__item__rounded">
                                    <a class="nav-link d-flex align-items-center justify-content-center active" aria-current="page" href="#">
