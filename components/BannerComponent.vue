    ...
    <div class="row d-flex justify-content-center align-items-center py-3 mb-3 banner">
        ...
        <div class="col-md-6">
            <div class="content px-3">
                ...
                <p class="mt-3 text-dark-secondary">
                    <span># ব্লগ</span>
                ...
                <button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#loginModal" v-if="!$auth.loggedIn">
                        ...
                        <div class="modal-body">
                            <div class="card-body p-0 login-section">
                                ...
                                <button class="btn btn-primary w-100 facebook mb-2 p-2 d-flex align-items-center justify-content-center" type="button" @click.prevent="loginFacebook">
                                    <b-spinner small v-if="isLoadingFacebook"></b-spinner>
                                ...
                                <button class="btn btn-danger google w-100 p-2 d-flex align-items-center justify-content-center" @click="loginGoogle">
                                    <b-spinner small v-if="isLoadingGoogle"></b-spinner>
